...
(function($){
    ...
    $.fn.autoComplete = function(opts){
        ...
        $(document).on("click","."+opts.css+" li",function(e){
            ...
            if($autoCompleteList[0].tagName == "LI"){
                ...
                if((beforeSelect = _autoComplete.beforeSelect.call($autoCompleteList,opts,data))) {
                    $ul[0]._input.value = data.value;
                    opts.selectCallback && opts.selectCallback.call($autoCompleteList, data);//回调方法
                }
            }
            if(beforeSelect) {
    ...
    var _autoComplete = {
        ...
        select:function(opts){
            ...
            if(_autoComplete.beforeSelect.call(autoCompleteConatiner,opts,data)){
                opts.selectCallback && opts.selectCallback.call(autoCompleteConatiner,data);//回调方法
